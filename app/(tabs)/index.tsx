...
export default function HomeScreen() 
{
  ...
  try {
    ...
    const aiResponse = await fetch('https://96f5-183-82-237-45.ngrok-free.app/analyze', {
      method: 'POST',
      body: formData,
      headers: {
  ...
  const validateAndLogin = async () => {
    ...
    try {
      const response = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/auth/login', {
        method: 'POST',
  ...
  const validateAndSignUp = async () => {
    ...
    try {
      const response = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/auth/signup', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          name: fullName,
...
const sendOtpToEmail = async () => {
  ...
  try {
    const res = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/send-otp', { 
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const verifyOTP = async () => {
    try {
      const res = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/verify-otp', { 
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const uploadToServer = async () => {
    try {
      ...
      const analyzeRes = await fetch('https://96f5-183-82-237-45.ngrok-free.app/analyze', {
        method: 'POST',
      ...
      await new Promise<void>((resolve, reject) => {
        ...
        xhr.open('POST', 'https://96f5-183-82-237-45.ngrok-free.app/api/upload/new');
  ...
  const resetPassword = async () => {
    ...
    try {
      const res = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        const res = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/upload/all');
        const data = await res.json();
        setAllReports(data);
      } catch (err) {
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      const response = await fetch('https://96f5-183-82-237-45.ngrok-free.app/generate-pdf', {
  ...
  const generateAndOpenPdf = async (html: string, fileName: string): Promise<void> => {
    try {
      const response = await fetch('https://96f5-183-82-237-45.ngrok-free.app/api/generate-pdf', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  useEffect(() => {
    const fetchUserHistory = async () => {
      try {
        ...
        const res = await fetch(`https://96f5-183-82-237-45.ngrok-free.app/api/upload/user/${userId}`);
        const data = await res.json();
        setHistoryData(data);
      } catch (error) {
  ...
  //       },
  //       body: JSON.stringify({
  //         imageUrl: `https://96f5-183-82-237-45.ngrok-free.app${report.imageUrl}`,
          ...
          {historyData.length === 0 ? (
            ...
            historyData.map((item, index) => (
              ...
              >
                {item.imageUrl && (
                  <Image
                    source={{ uri: `https://96f5-183-82-237-45.ngrok-free.app${item.imageUrl}` }}
                ...
                {loadingReports ? (
                  ...
                  allReports.map((report, index) => (
                    <TouchableOpacity
                        ...
                        {report.imageUrl ? (
                            <Image
                            source={{ uri: `https://96f5-183-82-237-45.ngrok-free.app${report.imageUrl}` }}
                            style={{
                                width: 60,
                                height: 60,
                                borderRadius: 10,
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
          <View style={{
            ...
            {selectedReport.imageUrl ? (
              <Image
                source={{ uri: `https://96f5-183-82-237-45.ngrok-free.app${selectedReport.imageUrl}` }}
                  ...
                  const htmlContent = `
                    <html>
                      <body>
                        ...
                        <img src="https://96f5-183-82-237-45.ngrok-free.app${selectedReport.imageUrl}" style="width:100%;max-width:400px;margin-top:20px;" />
                      </body>
                    </html>
                  `;
            ...
            {selectedReport.status !== 'Resolved' && (
              <TouchableOpacity
                ...
                onPress={async () => {
                  try {
                    const res = await fetch(`https://96f5-183-82-237-45.ngrok-free.app/api/upload/resolve/${selectedReport._id}`, {
                      method: 'PUT',
                      headers: { 'Content-Type': 'application/json' },
                    });
