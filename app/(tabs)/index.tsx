...
export default function HomeScreen() 
{
  ...
  try {
    ...
    const aiResponse = await fetch('https://e35c-2409-40f0-124-c76b-39a1-e8da-bd91-927e.ngrok-free.app/analyze', {
      method: 'POST',
      body: formData,
      headers: {
  ...
  const sendToAuthorities = async (report: Report) => {
    try {
        // const res = await fetch('http://localhost:8000/api/receive-report',
          ...
          const res = await fetch('http://192.168.28.177:8000/api/receive-report', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
